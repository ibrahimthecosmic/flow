...
import { getFlowTag } from "ext:runtime/http.js";
const {
  builtinTracer,
  enterSpan,
  TRACING_ENABLED,
...
class UserWorker {
  ...
  async fetch(request, options = {}) {
    ...
    if (tag === void 0 && tokioChannelTag === void 0) {
      ...
      console.warn(NO_FLOW_TAG_WARN_MSG);
    }
...
const FLOW_USER_WORKERS = UserWorker;

export { FLOW_USER_WORKERS };
