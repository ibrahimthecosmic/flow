...
class Session {
  ...
  constructor(model) {
    ...
    if (model === "gte-small") {
      ...
      // Optional bearer token for OpenAI-compatible endpoints (e.g. OpenAI,
      // OpenRouter, vLLM, llama.cpp) that require authentication.
      this.inferenceAPIKey = core.ops.op_get_env("AI_INFERENCE_API_KEY");
  ...
  async run(prompt, opts = {}) {
    ...
    const meanPool = opts.mean_pool ?? true;
